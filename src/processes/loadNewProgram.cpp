...
public:
    ...
    Busena execute(){
        switch (step){
        case 1:{
            Resource* resursas = arTuriResursa(ResourceType::naujosProgramosPaleidimas);
            if(resursas){
                step = 2;
                return Busena::READY;
            }
        ...
        case 3:{
            Resource* resursas = arTuriResursa(ResourceType::supervizorineAtmintis);
            if(resursas){
                step = 4;
                return Busena::READY;
            }
        ...
        case 4:{
            Resource* resursas = arTuriResursa(ResourceType::isorineAtmintis);
            if(resursas){
                step = 5;
                return Busena::READY;
            }
